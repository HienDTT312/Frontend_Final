...
function ProductsList() {
  ...
  async function getProducts() {
    let res = await axiosClient.get("http://localhost:3001/service1/product");
  ...
  useEffect(() => {
    async function getCategories() {
      const res = await axiosClient.get(
        "http://localhost:3001/service1/category"
      );
    ...
    async function getBrands() {
      const res = await axiosClient.get("http://localhost:3001/service1/brand");
  ...
  const handleClickDeleteProduct = (deleteProductId) => {
    axiosClient
      .delete(`http://localhost:3001/service1/product/${deleteProductId}`)
      .then((response) => {
  ...
  const handleClickDownloadAll = () => {
    ...
    axiosClient
      .get("http://localhost:3001/service1/csv", { responseType: "blob" })
      .then((res) => {
  ...
  const handleOnSubmitFilter = (e) => {
    ...
    axiosClient
      .get(`http://localhost:3001/service1/product?${paramString}`)
      .then((res) => {
        setProducts(res.data.data);
      })
      .catch((err) => console.log(err));
