  ...
  const renderRows = (brand, index, onClickDelete) => {
    ...
    return (
      ...
      >
        ...
        <td>{convertFormat(brand.start_date)}</td>
        <td>{convertFormat(brand.end_date)}</td>
        <td>{convertFormat(brand.first_closure_date)}</td>
        <td>{convertFormat(brand.final_closure_date)}</td>
        <td>{brand.status}</td>
        <td>
          <Link
